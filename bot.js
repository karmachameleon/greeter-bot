...
bot.on('guildMemberAdd', function(member) {
	bot.channels.get("393845951292243980").send('<@' + member.id + '> DETECTED. YOU HAVE BEEN ASSIMILATED TO THE ROBOT PIZZA PARTY. READ THE <#393842582414688269> AND POST AN INTRODUCTION  IN  <#396067802970193920>. ADD YOUR PRONOUNS IN <#516023523769319454> (LOOK IN <#516023523769319454> FOR INSTRUCTIONS) SHARE AND ENJOY :pizza:').catch(console.error);
});
