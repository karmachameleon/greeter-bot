...
'LOOKING FOR A SNACK IN THE FRIDGE AT 3AM', 'BREAKING THROUGH A WALL', 'INSIDE THE COCKPIT OF A MECHA', 'MAKING SNOW ANGELS', 'ATTEMPTING TO BEND A SPOON WITH PSYCHIC POWER', 'WAITING FOR THEIR NEWLY PAINTED NAILS TO DRY', 'SMASHING BREAKABLE OBJECTS ON THE GROUND IN WILD ABANDON', 'DIVING OFF A CLIFF'];
...
'IN A LUCHADOR OUTFIT', 'IN A SUPERHERO OR SUPERVILLAIN OUTFIT', 'IN A WILD WEST OUTFIT', 'IN A CHEERLEADING UNIFORM', 'IN A SPORTS UNIFORM (BASEBALL, FOOTBALL, HOCKEY, ET CETERA)', 'DRESSED AS A CLOWN', 'WEARING A SHEET GHOST COSTUME', 'WEARING ELABORATE JEWELRY', 'DRESSED AS ROYALTY', 'COSPLAYING A VOCALOID', 'WEARING A FANCY MASQUERADE MASK', 'DRESSED FOR BUSINESS COMPLETE WITH BRIEFCASE', 'IN AN ELABORATE WIG',
...
var ficevents = ["A GIANT ATTACKED", "THEY SAW SOMEONE WATCHING THEM FROM THE BUSHES", "A WHOLE BUNCH OF BIRDS FLEW OVERHEAD", "THEY FELL DOWN A WORMHOLE", "LIGHTNING STRUCK", "AN EARTHQUAKE STRUCK", "A HERD OF BUFFALO STAMPEDED PAST", "SOMEONE RAN PAST THEM SCREAMING", "A GROUP OF PIG SOLDIERS DEMANDED THEIR SURRENDER"];
