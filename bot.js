...
var nounDict = { SHE: {id:'515983960606507024', subject:'SHE', object:'HER', deter:'HER', possess:'HERS', reflex:'HERSELF', have:'HAS'}, HE: {id:'515983432975908907', subject:'HE', object:'HIM', reflex:'HIS', possess:'HIS', reflex:'HIMSELF', have:'HAS'}, THEY: {id:'515983966667276360', subject:'THEY', object:'THEM', reflex:'THEIR', possess:'THEIRS', reflex:'THEMSELF', have:'HAVE'},
FAE: {id:'515983996681977869', subject:'FAE', object:'FAER', deter:'FAER', possess:'FAERS', reflex:'FAERSELF', have:'HAS'}, VOI: {id:'515983996010627099', subject:'VOI', deter:'VOIDS', object:'VOID', possess:'VOIDS', reflex:'VOIDSELF', have:'HAS'}, E:{id:'515984166370803758', subject:'E', object:'EM', reflex:'EIR', possess:'EIRS', reflex:'EMSELF', have:'HAS'},
ANY: {id:'515983985617403904', subject:'HE', object:'THEM', deter:'HER', possess:'HERS', reflex:'THEMSELF', have:'HAS'} };
...
var promptchars = ['WILSON', 'WILLOW', 'WOLFGANG', 'WENDY', 'ABIGAIL', 'WX-78', 'WICKERBOTTOM', 'WOODIE', 'LUCY THE AXE', 'MAXWELL', 'WILLIAM CARTER', 'WES', 'WIGFRID', 'A STAGEHAND', 'BERNIE THE TEDDY BEAR',
'WEBBER', 'WALANI', 'WARLY', 'WOODLEGS', 'WILBUR', 'CHARLIE', 'WINONA', 'CHESTER', 'HUTCH', 'PACKIM BAGGINS', 'A PIGMAN', 'A MERM', 'MR. SKITS', 'A CATCOON', 'A HOUND', 'GLOMMER', 'A BUNNYMAN' ];
...
'DANCING', 'RIDING A BEEFALO', 'HOSTING A TEA PARTY', 'SAILING A PIRATE SHIP. YARRRR', 'AS A GRUE OR SHADOW CREATURE (OR HUMANIZED, IF THEY ALREADY WERE ONE)', 'SINGING A SONG YOU LIKE OR ASSOCIATE WITH THEM', 'AS A STUFFED ANIMAL (OR, IF BERNIE, AS A LIVING CREATURE)', 'AS A DRAGON', 'DEALING WITH SUMMER HEAT', 'IN A FLOWER GARLAND', 'WITH BEAUTIFUL ANIME EYES',
'IN A LUCHADOR OUTFIT', 'AS A SUPERHERO OR SUPERVILLAIN', 'WITH THE OPPOSITE OF THEIR USUAL PERSONALITY', 'COSPLAYING A VOCALOID', 'IN COZY WARM CLOTHING', 'WITH A POKEMON PARTNER', 'LOST AND CONSULTING A MAP', 'IN AN ELABORATE WIG', 'EXPLORING THE ANCIENT RUINS', 'DIGGING UP TREASURE', 'IN A BEEKEEPER OUTFIT, HARVESTING HONEY', 'MAKING A GOOFY FACE',
...
' ADOPT A SMALLBIRD TOGETHER AND ATTEMPT TO RAISE IT', ' DEFACE A STATUE OF MAXWELL TOGETHER', ' PREPARE A FEAST TO CELEBRATE THE END OF WINTER'];
      ...
      case 'PRONOUN':
        if (msg.content.split(' ').length == 1) {
          ...
          if(!nounDict.hasOwnProperty(nounAsk)){
            ...
            chan.send('SUCCESSFULLY IDENTIFIED <@' + msg.author.id + '>. ' + set.object + ' ' + set.have + ' IDENTIFIED ' + set[reflex] + ' TO MY SYSTEMS AND ' + set[deter] + ' CHOICE, WHICH IS ' + set[possess] + ', WILL BE RESPECTED. YOU MAY CONGRATULATE ' + set[object] + 'AT YOUR LEISURE').catch(console.error);
          }
        }
      break;
